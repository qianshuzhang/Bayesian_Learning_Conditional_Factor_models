function [X, States, l, lnpdf_prior, AcceptRate] = MoveSet(X, States, l, lnpdf_prior, prior_param, Ret,initial_h,n_factors)
...
[X_proposal, logprop_orig, logprop_proposal] = SimProposalTrMixtureNormal(X, Ndim, Ntr,n_factors);
